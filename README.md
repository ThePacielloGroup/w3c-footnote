...
Extends the HTML footer (http://www.w3.org/html/wg/drafts/html/master/sections.html#the-footer-element) element to identify its use for footnotes. Adds sub-role label text (offscreen) and icon via CSS. adds ARIA [role=note](http://www.w3.org/TR/wai-aria/roles#note)
